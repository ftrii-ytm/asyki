                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <?php
                        ...
                        $dashboardUrl = match($user->role ?? '') {
                            'pengaju' => url('/pengajuan'),
                            'ga' => url('/ga'),
                            'keuangan' => url('/keuangan'),
                            'payment' => url('/payment'),
                            default => url('/')
                        };
                    ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => $dashboardUrl,'active' => request()->is(trim(parse_url($dashboardUrl, PHP_URL_PATH), '/'))]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($dashboardUrl),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->is(trim(parse_url($dashboardUrl, PHP_URL_PATH), '/')))]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => $dashboardUrl,'active' => request()->is(trim(parse_url($dashboardUrl, PHP_URL_PATH), '/'))]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH C:\Users\CONAN\asyki\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>